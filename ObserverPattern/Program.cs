...
namespace ObserverPattern
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            NovasAgenciasNoticias agenciasNoticias1 = new NovasAgenciasNoticias("Agência de Notícia de São Paulo");
            estacaoMeteorologica.Anexar(agenciasNoticias1);

            NovasAgenciasNoticias agenciasNoticias2 = new NovasAgenciasNoticias("Agência de Notícia de Suzano");
